...
class NotificationHelper(base: Context?) : ContextWrapper(base) {
    ...
    private fun createChannels() {
        ...
        val manager = getSystemService(ContextWrapper.NOTIFICATION_SERVICE) as NotificationManager
    ...
    fun sendHighPriorityNotification(title: String?, body: String?, activityName: Class<*>?) {
        ...
        val notification =
            NotificationCompat.Builder(this, CHANNEL_ID) //                .setContentTitle(title)
                ...
                .setContentTitle("Panel Surya Notifikasi")
                .setPriority(NotificationCompat.PRIORITY_HIGH)
                .setStyle(
                    NotificationCompat.BigTextStyle().setSummaryText("Panel Surya")
